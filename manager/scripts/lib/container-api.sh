...
container_create_worker() {
    ...
    # External: default bridge network, worker resolves domains via real DNS (Cloudflare)
    # Local: hiclaw-net, Docker DNS resolves *-local.hiclaw.io via manager's network aliases
